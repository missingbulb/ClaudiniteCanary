...
| `canary-role` | canary | What ClaudiniteCanary is for and how to work in it — the live canary for Claudinite's consumer-safety gate. Use before changing anything in this repo, and when a canary rehearsal comes back red and you have to decide what the red means. |
